<html>
	...
	<body>
		...
		<div class="body_content" style="display: flex;">
			<div id="sidebar" style="height: 722px;">
			...
			<div id="content">
				<?php 
					...
					if(isset($_POST["sbtn"])){
						...
						echo '<script type="text/javascript">alert("User deatails deleted Successfully !"); location.replace("admin_Customers.php")</script>';
					}
